...
<nav>
 ...
 <?php
      $select_user = mysqli_query($conn, "SELECT * FROM `userss_form` WHERE id = '$user_id'") or die('query failed');
...
<div class="shopping-cart">
   ...
   <div class="cart-btn">  
      <a href="pay.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">BUY NOW</a>
   </div>
...
<div class="user-profile">
 ...
 <p> welcome to our shopping page</p>
   <div class="flex">
